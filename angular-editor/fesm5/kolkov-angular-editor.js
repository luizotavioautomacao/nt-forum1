...
var AngularEditorService = /** @class */ (function () {
     ...
     * @return {?}
     */
        function (imageUrl, width, height) {
            var ratio = Math.min(492 / width, 277 / height);
            var widthC = width*ratio;
            var heightC = height*ratio;
            var img = "<img width='"+widthC+"' height='"+heightC+"' src='" + imageUrl + "'>";
            this.insertHtml(img);
        };
    /**
     * @param {?} separator
     ...
     */
        function (videoUrl) {
            ...
            /** @type {?} */
            console.log(id)
            var thumbnail = "<iframe width='492' height='277' src='https://www.youtube.com/embed/" + id + "' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
...
var AngularEditorToolbarComponent = /** @class */ (function () {
     ...
     */
        function () {
            ...
            url = prompt('Inserir URL link', url);
     ...
     */
        function () {
            this.execute.emit('');
            /** @type {?} */
            var url = prompt('Inserir link do YOUTUBE', "https://");
            if (url && url !== '' && url !== "https://") {
            ...
            if (file.type.includes('image/')) {
                 ...
                 */
                        function (e) {
                            ...
                            i.onload = function () {
                                _this.editorService.insertImage(fr.result.toString(), i.width, i.height);
                            };
